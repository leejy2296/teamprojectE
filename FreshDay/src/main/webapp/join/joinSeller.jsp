    ...
    <form name="joinForm" action="joinSeller_proc.jsp" method="post">
        ...
        <ul>
            ...
            <li>
                <label>사업자등록번호 *</label>
                <span>
                    <input type="number" name="sellernumber1" class="input3" id="sellno1" oninput ="numberMax(this, 3)" placeholder="3자리 숫자">
                    <input type="number" name="sellernumber2" class="input3" id="sellno2" oninput ="numberMax(this, 2)" placeholder="2자리 숫자">
                    <input type="number" name="sellernumber3" class="input3" id="sellno3" oninput ="numberMax(this, 5)" placeholder="5자리 숫자">
                </span>
